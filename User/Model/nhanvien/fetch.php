...
{	
	...
	$sub_array[] = $hdshow;
	$sub_array[] = '<button type="button" disabled name="update" id="'.$row["Id"].'" class="btn btn-warning btn-xs update">Sửa</button>';
	$sub_array[] = '<button type="button" disabled name="delete" id="'.$row["Id"].'" class="btn btn-danger btn-xs delete">Xóa</button>';	
	$data[] = $sub_array;
}
$output = array(
