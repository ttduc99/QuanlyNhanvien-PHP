...
<head>
  ...
  <title>Quản lý hợp đồng - AD</title>
...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <?php include("Share/topnav.php");?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Quản lý Hợp đồng lao động</h1>
			<!-- <a class="dropdown-item" id="add_button" href="#" data-toggle="modal" data-target="#themhopdong">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="banghopdong" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>Mã nhân viên</th>
                      <th>Tên</th>
  ...
  <!-- Logout Modal-->
  <div class="modal fade" id="themhopdong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="min-width:800px" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
			<form method="POST" id="hopdong_form">
        <div class="row">          
        ...
        <div class="modal-footer">
          <input type="hidden" name="hdld_id" id="hdld_id" />
  ...
  <script type="text/javascript" language="javascript" > 
	...
	$(document).ready(function(){
		...
		// 	$('#hopdong_form')[0].reset();
		// 	$('.modal-title').text("Thêm nhân viên");
		// 	$('#action').val("Thêm");
		// 	$('#operation').val("Add");
		// });
		
		var dataTable = $('#banghopdong').DataTable({
			"processing":true,
			"serverSide":true,
			"order":[],
			"ajax":{
				url:"Model/hopdong/fetch.php",
				type:"POST"
			},
			"columnDefs":[
				{
		...
		$(document).on('click', '.update', function(){
			var hdld_id = $(this).attr("id");
      $("hdld_id").val(hdld_id);
			$.ajax({
				url:"Model/hopdong/fetch_single.php",
				method:"POST",
				data:{hdld_id:hdld_id},
				dataType:"json",
				success:function(data)
				{
					$('#themhopdong').modal('show');
          $('#hdld_id').val(hdld_id);
          $('.modal-title').text("Sửa Hợp đồng lao động");
		...
		$(document).on('submit', '#hopdong_form', function(event){
