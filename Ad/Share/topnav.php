<?php
  if((isset($_COOKIE["Name"]))){
    if($_COOKIE["Role"]==0){
      ...
      header("Location: /bai3/User/index.php");
    }
  }
  else{
      ...
      <?php
       ...
       {	
         ...
         if((int)date('d',$time)==(int)date('d')&&(int)date('m',$time)==(int)date('m')){
           echo '<a type="button" class="dropdown-item d-flex align-items-center" data-toggle="modal" data-target="#sinhnhat" data-whatever="@'.$row["Id"].'">
           <div class="mr-3">
