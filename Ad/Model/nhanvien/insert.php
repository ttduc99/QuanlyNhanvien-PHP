...
if(isset($_POST["operation"]))
{
	...
	{			
		...
		$statement = $connection->prepare("
			 INSERT INTO nhanvien (Id, Ho, Ten, NgaySinh, DiaChi, GioiTinh, SoDienThoai, ChucVuId, PhongBanId, HDLDId,Password,Status) 
			VALUES (:id,:ho,:ten,:ngaysinh,:diachi,:gioitinh,:sdt,:chucvu,:phongban,:hdld,:pass,:status)
		");
